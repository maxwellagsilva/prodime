    ...
    <div className="lp-container">
      ...
      <section id="como-funciona" style={{ padding: '80px 20px', maxWidth: '1200px', margin: '0 auto', borderTop: '1px solid var(--border-color)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '30px', textAlign: 'left', marginTop: '40px' }}>
          {[
            { step: '1', title: 'Cadastro do projeto', desc: 'O usuário informa os dados gerais da estimativa, como nome do projeto, nome da unidade de saúde, cidade, estado, responsável pelo preenchimento e observações relevantes. Essas informações ajudam a identificar o projeto e compor o relatório final.' },
