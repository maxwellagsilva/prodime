  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '2fr 1.2fr', gap: '24px', alignItems: 'start' }} className="wizard-layout-grid">
      ...
      <div className="card-premium" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        <div>
          <h2 className="card-title" style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '1.4rem', fontFamily: 'var(--font-display)', fontWeight: 700 }}>
            <HelpCircle size={24} style={{ color: 'var(--primary)' }} /> Central de Ajuda & Como Usar
          </h2>
          <p style={{ fontSize: '0.88rem', color: 'var(--secondary-light)', marginTop: '8px', lineHeight: '1.6' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', alignItems: 'start' }}>
            <div style={{ backgroundColor: 'rgba(20, 83, 45, 0.08)', color: 'var(--primary)', borderRadius: '12px', padding: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              <FileText size={20} />
            </div>
            <div>
              <h3 style={{ fontSize: '1rem', fontWeight: 700, color: 'var(--secondary)', marginBottom: '6px', fontFamily: 'var(--font-display)' }}>1. Cadastre os Dados Gerais</h3>
          ...
          <div style={{ display: 'flex', gap: '16px', alignItems: 'start' }}>
            ...
            <div>
              <h3 style={{ fontSize: '1rem', fontWeight: 700, color: 'var(--secondary)', marginBottom: '6px', fontFamily: 'var(--font-display)' }}>2. Escolha as Áreas e Setores</h3>
              <p style={{ fontSize: '0.85rem', color: 'var(--secondary-light)', lineHeight: '1.5' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', alignItems: 'start' }}>
            ...
            <div>
              <h3 style={{ fontSize: '1rem', fontWeight: 700, color: 'var(--secondary)', marginBottom: '6px', fontFamily: 'var(--font-display)' }}>3. Insira as Capacidades Operacionais</h3>
              <p style={{ fontSize: '0.85rem', color: 'var(--secondary-light)', lineHeight: '1.5' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', alignItems: 'start' }}>
            ...
            <div>
              <h3 style={{ fontSize: '1rem', fontWeight: 700, color: 'var(--secondary)', marginBottom: '6px', fontFamily: 'var(--font-display)' }}>4. Revise os Resultados e Faça Ajustes</h3>
              <p style={{ fontSize: '0.85rem', color: 'var(--secondary-light)', lineHeight: '1.5' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
        <div className="card-premium" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <h2 className="card-title" style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '1.25rem', fontFamily: 'var(--font-display)', fontWeight: 700 }}>
            <MessageSquare size={22} style={{ color: 'var(--primary)' }} /> Suporte Técnico
          </h2>
          <p style={{ fontSize: '0.85rem', color: 'var(--secondary-light)', lineHeight: '1.6' }}>
          ...
          <div style={{ backgroundColor: 'var(--bg-app)', padding: '16px', borderRadius: '12px', border: '1px solid var(--border-color)', display: 'flex', alignItems: 'center', gap: '12px' }}>
            <Mail style={{ color: 'var(--primary)' }} size={20} />
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)', textTransform: 'uppercase', fontWeight: 700 }}>E-mail de Contato</span>
              <a href="mailto:suporte@prodime.com.br" style={{ fontSize: '0.9rem', color: 'var(--secondary)', fontWeight: 700, textDecoration: 'none' }}>
          ...
          <a 
            ...
            style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', padding: '12px', fontSize: '0.9rem', fontWeight: 600, textDecoration: 'none' }}
          >
            Falar com o Suporte <ArrowRight size={16} />
          </a>
        </div>

        <div className="card-premium" style={{ backgroundColor: 'rgba(20, 83, 45, 0.02)', border: '1px dashed var(--primary)' }}>
